...
const Nav = () => {
    return (
        <nav className="NAV">
            <a href="/" className='NAV__logo'> <svg className='NAV__logo-svg'width="38" height="48" viewBox="0 0 38 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <ul className='NAV__list'>
                ...
                <li className='NAV__list-item'>Stories</li>
            </ul>
